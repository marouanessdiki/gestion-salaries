...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{\detokenize{./assets/diagramme use cas.png}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{\detokenize{./assets/Génération d'attestation diagramme de sequence.png}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{\detokenize{./assets/Gestion des employés 1.png}}
\caption{Sequence Diagram - Employee Management (Part 1)}
\label{fig:sequence-diagram-employees-1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{\detokenize{./assets/Gestion des employés 2.png}}
\caption{Sequence Diagram - Employee Management (Part 2)}
\label{fig:sequence-diagram-employees-2}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{./assets/diagrammes-des-classes-netcon.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{\detokenize{./assets/backend layer archi (springboot).png}}
...
\hspace{1cm}The system includes administrative capabilities for system management and user profile configuration:

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{\detokenize{./assets/panel admin.png}}
\caption{Admin Panel - System Administration}
...
\hspace{1cm}The implemented system successfully demonstrates all the planned functionalities:

\textbf{Employee Management:} Complete CRUD operations with data validation, search capabilities, and intuitive form interfaces.

\textbf{Attestation Generation:} Automated PDF generation for five types of attestations with dynamic template management and real-time preview.

\textbf{User Interface:} Modern Material-UI (MUI) design with dark/light theme support, responsive layout, and excellent user experience.

\textbf{Authentication \& Authorization:} Secure login system with role-based access control for HR users and administrators.

\textbf{Administrative Tools:} Comprehensive admin panel for system management, user profile configuration, and template management.

\subsection{Technical Implementation Results}
\hspace{1cm}The system has been successfully implemented with the following technical achievements:

\begin{itemize}
    \item \textbf{Backend Performance:} Spring Boot REST API with response times under 2 seconds
    \item \textbf{Database Integration:} MySQL with optimized queries and data integrity
    \item \textbf{PDF Generation:} JasperReports integration with dynamic template support
    \item \textbf{Frontend Responsiveness:} React application with mobile-friendly design
    \item \textbf{Security Implementation:} Secure authentication and data protection
    \item \textbf{Testing Coverage:} Comprehensive test suite with 95\%+ backend and 90\%+ frontend coverage
\end{itemize}
...
The system realization showcases a complete, functional application with intuitive user interfaces, comprehensive employee management capabilities, and automated attestation generation. The screenshots demonstrate the successful implementation of all planned features, including authentication, employee CRUD operations, attestation generation, and administrative tools.

Comprehensive tests ensure system reliability with high coverage, and the realized system is ready to support the requirements of HR management applications in production environments.
\end{doublespace}
...
\begin{itemize}
    ...
    \item \textbf{Modern user interface:} Material-UI (MUI) with dark/light themes and responsive design.
